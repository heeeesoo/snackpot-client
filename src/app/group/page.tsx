        ...
        <div className="w-screen max-w-[500px] flex flex-col items-center">
            ...
            : <div></div>}
            {
                ...
                <div className=" w-fixwidth h-[80vh] flex flex-col justify-center items-center">
                    ...
                    <div className="text-[24px] flex-col justify-center text-center">
                    ...
                    return(
                        <div key={group.groupId} onClick={(e)=>handleClickGroup(group.groupId, e)} className="flex px-[20px] py-[20px] flex-col h-[112px] w-fixwidth bg-white mb-[12px] rounded-[16px]">
                            <div className="flex flex-row items-stretch justify-between">
                                ...
                                <div className="flex flex-row items-center text-center justify-center text-[14px] text-SystemGray3">
                                    <Image
                                    alt="Crown"
                                    src={Crown}
                                    width={16}
                            ...
                            <div className="text-[12px] justify-between flex items-center flex-row mt-[8px] text-SystemGray3">
                                ...
                                <div>
                                    ...
                                    <button className=" bg-grayScreen w-[70px] rounded-md h-[30px] flex items-center justify-center text-SystemGray3 text-center" id="delete">그룹 삭제</button>
                                    :
                                    <div></div>
                                    }
                                </div>
            ...
            <div className="fixed bottom-[100px] rounded-full right-4" onClick={handleClickCreate}>
                <button className="bg-SystemBrand shadow-2xl hover:bg-blue-700 text-center flex items-center justify-center text-[40px] h-[56px] w-[56px] text-white rounded-full">
                    <Image
                    alt="plus"
                    src={Plus}
                    width={24}
